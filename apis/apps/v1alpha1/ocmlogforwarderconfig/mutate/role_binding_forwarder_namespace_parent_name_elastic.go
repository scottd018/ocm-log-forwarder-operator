...
// MutateRoleBindingForwarderNamespaceParentNameElastic mutates the RoleBinding resource with name parent.name + -elastic.
func MutateRoleBindingForwarderNamespaceParentNameElastic(
