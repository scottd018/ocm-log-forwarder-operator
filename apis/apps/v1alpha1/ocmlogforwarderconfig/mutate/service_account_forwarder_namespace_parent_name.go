...
// MutateServiceAccountForwarderNamespaceParentName mutates the ServiceAccount resource with name parent.Name.
func MutateServiceAccountForwarderNamespaceParentName(
