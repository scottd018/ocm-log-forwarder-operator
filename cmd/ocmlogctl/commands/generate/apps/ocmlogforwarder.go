...
// GenerateOCMLogForwarder runs the logic to generate child resources for a
// OCMLogForwarder workload.
func GenerateOCMLogForwarder(g *cmdgenerate.GenerateSubCommand) error {
