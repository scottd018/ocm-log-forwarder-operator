...
// OCMLogForwarderReconciler reconciles a OCMLogForwarder object.
type OCMLogForwarderReconciler struct {
	client.Client
	Name         string
	Log          logr.Logger
...
func NewOCMLogForwarderReconciler(mgr ctrl.Manager) *OCMLogForwarderReconciler {
	return &OCMLogForwarderReconciler{
		Name:         "OCMLogForwarder",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorderFor("OCMLogForwarder-Controller"),
		FieldManager: "OCMLogForwarder-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("apps").WithName("OCMLogForwarder"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
	}
}
...
func (r *OCMLogForwarderReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
...
func (r *OCMLogForwarderReconciler) GetEventRecorder() record.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *OCMLogForwarderReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *OCMLogForwarderReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *OCMLogForwarderReconciler) GetName() string {
	return r.Name
}

// GetController returns the controller object associated with the reconciler.
func (r *OCMLogForwarderReconciler) GetController() controller.Controller {
	return r.Controller
}

// GetWatches returns the objects which are current being watched by the reconciler.
func (r *OCMLogForwarderReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *OCMLogForwarderReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *OCMLogForwarderReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.OCMLogForwarderCheckReady(r, req)
}
...
func (r *OCMLogForwarderReconciler) Mutate(
	req *workload.Request,
	object client.Object,
) ([]client.Object, bool, error) {
	return mutate.OCMLogForwarderMutate(r, req, object)
}

func (r *OCMLogForwarderReconciler) SetupWithManager(mgr ctrl.Manager) error {
	r.InitializePhases()

	baseController, err := ctrl.NewControllerManagedBy(mgr).
		WithEventFilter(predicates.WorkloadPredicates()).
		For(&appsv1alpha1.OCMLogForwarder{}).
		Build(r)
	if err != nil {
